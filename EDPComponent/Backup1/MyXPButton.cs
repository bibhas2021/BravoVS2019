...
namespace EDPComponent
{
	...
	public class MyXPButton : System.Windows.Forms.Button
	{
		...
		public MyXPButton()
		{
			...
			InitializeComponent();
            this.MouseMove += new MouseEventHandler(MyXPButton_MouseMove);
        ...
        void MyXPButton_MouseMove(object sender, MouseEventArgs e)
        {
            if (tooltip)
            {
        ...
        [Category("Value"),DefaultValue(true),Description("The value that is displayed on the progress bar.")]
...
//			rcBackground.Y = 150;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MyXPButton));
			// 
			// MyXPButton
			// 
