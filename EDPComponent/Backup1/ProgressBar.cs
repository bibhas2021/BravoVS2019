...
namespace EDPComponent
{
    ...
    public class ProgressBar : System.Windows.Forms.UserControl
    {
        ...
        public ProgressBar()
        {
            ...
            lblValue.Location = new Point((this.Width - lblValue.Width) / 2, (this.Height - lblValue.Height) / 2);
            lblValue.Text = Convert.ToString((this.Value / this.MaxValue) * 100) + "%";
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.lblValue.Location = new System.Drawing.Point(118, 10);
            this.lblValue.Name = "lblValue";
            this.lblValue.Size = new System.Drawing.Size(27, 13);
            ...
            this.FontChanged += new System.EventHandler(this.ProgressBar_FontChanged);
            this.Resize += new System.EventHandler(this.ProgressBar_Resize);
            this.ForeColorChanged += new System.EventHandler(this.ProgressBar_ForeColorChanged);
        ...
        private HorizontalAlignment textallign=HorizontalAlignment.Left;
        #region -  Value  -
        ...
        /// <summary>
        /// The Percentage will be Shown or Not.
        /// </summary>
        [Category("Value"),
        DefaultValue(true),
        Description("Percentage Will be Visible or not.")]
        public bool ShowPercentage
        {
            ...
            set
            {
                ...
                lblValue.Visible = showpercentage;
            }
        }
        [Browsable(true)]
        ...
        public HorizontalAlignment TextAllign
        {
            get
            {
                return textallign;
        ...
        protected void SetPercent()
        {
            ...
            {
                double v = this.Value;
                double v1 = this.MaxValue - this.MinValue;
                double v2 = (v / v1) * 100;
                lblValue.Text = v2.ToString("0") + "%";
            }
        }
        ...
        private void ProgressBar_ForeColorChanged(object sender, EventArgs e)
        {
            ...
            lblValue.ForeColor = this.ForeColor;
        }

        private void ProgressBar_FontChanged(object sender, EventArgs e)
        {
