    ...
    {        
      ...
      //  DataView dv;
        ...
        private void InitializeComponentLOV()
        {
            ...
            panel1.Name = "panel1";
            panel1.Size = new System.Drawing.Size(230, 300);
            panel1.TabIndex = 0;
            // 
            // DG1
            // 
          ...
          //  dgv.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle7;
            ...
            dgv.Size = new System.Drawing.Size(220, 230);
            dgv.TabIndex = 0;
            ...
            //change Subrata
           // LOVFORM.WindowState = FormWindowState.Maximized;
            LOVFORM.ClientSize = new System.Drawing.Size(500,500);
           ...
           // LOVFORM.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle;
            ...
            LOVFORM.MaximizeBox = true;
            LOVFORM.MinimizeBox = true;
            LOVFORM.ShowInTaskbar = false;
            LOVFORM.FormBorderStyle = FormBorderStyle.Sizable;
        ...
        private void LOV_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (Heading == "Select Voucher")
                    {
                        LOVFORM.WindowState = FormWindowState.Maximized;
                        LOVFORM.ClientSize = new System.Drawing.Size();
                        dgv.Columns[2].Width = 400;
                        dgv.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopLeft;
                      //dgv.Columns[2].a
                    }
