...
namespace Edpcom
{
    ...
    public class EDPConnection
    {
        ...
        private string UserName = "edp";
        private string Password = "2477147edp";
        public string connectionstr = "";
        bool status, PSI;
        public SqlConnection mycon;
        string mainDataSourch = "", mainNetworkLibrary = "", mainIntegratedSecurity = "", maintxtuserID = "edp", mainPassword = "2477147edp", mainConnectiontime = "", mainstatus = "", DSE = "\\SQLEXPRESS";
        ...
        public EDPConnection()
        {
            ...
            //this.DatabaseName = "EDP_Payroll"; //SchoolManagement//EDPComm.PDATABASE_NAME;
            ...
            //this.maintxtuserID = "edp";
            //this.mainPassword = "2477147edp";
