...
namespace Edpcom
{
    ...
    public class EDPCommon
    {
        ...
        private static string CURRENCOMP, CURRENTEC;
        ...
        public string GetDocNumber(Int64 Desccode, string Tentry,string session)
        {
            try
            {
                ...
                edpcon.Open();
                string docnumber = "";
                mycmd = new SqlCommand("select method from typedoc where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "'", edpcon.mycon);// and session ='"+session+"'"
                mydr = mycmd.ExecuteReader();
                mydr.Read();
                if (mydr.GetString(0).Trim() == "A")
                {
                    mydr.Close();
                    mycmd = new SqlCommand("select * from docnumber where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "'", edpcon.mycon);//and session ='" + session + "'"
                    mydr = mycmd.ExecuteReader();
                    mydr.Read();
                    string PREPOS = mydr.GetString(7);
                    string SUFPOS = mydr.GetString(8);
                    ...
                    string no_sep = mydr.GetString(11);
                    string prefix = mydr.GetString(12).Trim();
                    string suffix = session;//mydr.GetString(13).Trim();
                    mydr.Close();
                    mycmd = new SqlCommand("select count(*) from docgen where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "' and session ='" + session + "'", edpcon.mycon);
                    mydr = mycmd.ExecuteReader();
                    mydr.Read();
                    docnumber = mydr.GetValue(0).ToString();
                    mydr.Close();
                    string sep = "", num = ""; int i = 0;
                    Int64 newnum = 0;
                    for (i = 1; i <= Convert.ToInt16(no_sep); i++) sep = sep + "/";
                ...
                {
                    mydr.Close();
                    mycmd = new SqlCommand("select VOUCHERNO from docgen where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "'and session ='" + session + "'", edpcon.mycon);
                    mydr = mycmd.ExecuteReader();
                    mydr.Read();
                    docnumber = mydr.GetString(0);
                }
        ...
        public void Autobackup()
        {
            ...
            try
            {
                ...
                string path = backuppath + "\\" + PDATABASE_NAME +"_"+ DateAndTime.Now.ToString("MMddyyyyhhmmss") + "." + ApplicationExtension;
                edpcon.Open();
        ...
        public void UpdateDocNumber(Int64 Desccode, string Tentry, int vouno,string session)
        {
            try
            {
                EDPConnection con = new EDPConnection();
                ...
                //=========================                
                SqlDataReader mydr;
                mycmd = new SqlCommand("select voucherno from docgen where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "' and session ='" + session + "'", con.mycon);
                mydr = mycmd.ExecuteReader();
                mydr.Read();
                int ss = Convert.ToInt32(mydr.GetString(0).Trim());
                mydr.Close();
                if (vouno >= ss)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select * from DOCGEN where FICode='" + CurrentFicode + "' And GCode='" + PCURRENT_GCODE + "' And T_ENTRY='" + Tentry + "' And DESCCODE=" + Desccode + " And VOUCHERNO <>" + docnumber + "  and session ='" + session + "'", con.mycon);
                    da.SelectCommand = cmd;
                    da.Fill(ds, "dogno");
                    if (ds.Tables["dogno"].Rows.Count > 0)
                    {
                        cmd = new SqlCommand("delete from DOCGEN where voucherno='" + docnumber + "' and ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "' and session ='" + session + "' ", con.mycon);
                        cmd.ExecuteNonQuery();
                        string command = "update docgen set voucherno='" + docnumber + "' where ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "' and session ='" + session + "' ";
                        SqlCommand com = new SqlCommand(command, con.mycon);
                        com.ExecuteNonQuery();
                    }
                    else
                    {
                        cmd = new SqlCommand("delete from DOCGEN where voucherno='" + docnumber + "' and ficode='" + CurrentFicode + "' and gcode='" + PCURRENT_GCODE + "' and desccode='" + Desccode + "' and t_entry='" + Tentry + "'and session ='" + session + "' ", con.mycon);
                        cmd.ExecuteNonQuery();
                        cmd = new SqlCommand("insert into DOCGEN(Ficode,GCODE,T_ENTRY,DESCCODE,VOUCHERNO,State,User_Code,session) Values('" + CurrentFicode + "','" + PCURRENT_GCODE + "','" + Tentry + "'," + Desccode + "," + docnumber + ",'RUNNING','" + User_ID + "','" + session + "')", con.mycon);
                        cmd.ExecuteNonQuery();
                    }
                }
                con.Close();
        ...
        public void UpdateWaccLog(Form FormName, Boolean Opn_Close)
        {
            ...
            try
            {
                ...
                if (Opn_Close)
                {
                    ...
                    //}
                    //edpcon.Close();
                    DataTable DT_CURUSER = GetDatatable("SELECT DISTINCT USER_LEV FROM pasword P,AccordFourlogDetail A WHERE A.LOG_UCODE=P.USER_CODE AND Exclusive='0'", edpcon.mycon);
                    try
                    {
                         string str_User = "";
        ...
        public void delCurrentVoucher(string tentry, int vouc ,Int64 doc,string session)
        {
            EDPConnection edpcon = new EDPConnection();
            EDPCommon edpcom = new EDPCommon();
            try
            {
                edpcon.Open();
                string sql = "Select Voucherno from docgen where ficode='" + edpcom.CurrentFicode + "' and gcode='" + edpcom.PCURRENT_GCODE + "' and t_entry='" + tentry + "' and DESCCODE='" + doc + "'and session ='" + session + "' ";
                ...
                if (dr.Read())
                {
                    ...
                    if (ss == vouc)
                    {
                        try
                        {
                            string max_bill = "";
                            if(tentry =="1" || tentry =="2" || tentry =="3" || tentry =="4" || tentry =="5" || tentry =="6" || tentry =="7")
                                max_bill = edpcom.GetresultS("select max(USER_VCH) from data  where ficode=" + edpcom.CurrentFicode + " and gcode=" + edpcom.PCURRENT_GCODE + " and  t_entry='" + tentry + "'and DESCCODE='" + doc + "'and session ='" + session + "'");                            
                            else
                                max_bill = edpcom.GetresultS("select max(user_vch) from idata  where ficode=" + edpcom.CurrentFicode + " and gcode=" + edpcom.PCURRENT_GCODE + " and  t_entry='" + tentry + "'and DESCCODE='" + doc + "'and session ='" + session + "'");
                            //ss = 0;
                             if (max_bill != null)
                             {
                                 if (max_bill != "")
                        ...
                        edpcom.RunCommand("delete from docgen where Voucherno=" + a + " and ficode='" + edpcom.CurrentFicode + "' and gcode='" + edpcom.PCURRENT_GCODE + "' and t_entry='" + tentry + "' and DESCCODE='" + doc + "'and session ='" + session + "'");
                        edpcom.RunCommand("update docgen set Voucherno=" + a + " where ficode='" + edpcom.CurrentFicode + "' and gcode='" + edpcom.PCURRENT_GCODE + "' and t_entry='" + tentry + "' and DESCCODE='" + doc + "'and session ='" + session + "' ");
                    }
                    dr.Close();
                    edpcon.Close();
                }
        ...
        public void InsertMidasLog(Form FormName, Boolean Opn_Close, string func, string job)
        {
            EDPConnection edpcon = new EDPConnection();
            ...
            try
            {
                ...
                if (Opn_Close)
                {
                    if (Exclusive)
                        ...
                        xlsv = 0;
                    string Sql = "insert into Midaslog([LOG_UCODE],[LOG_GCODE],[LOG_CCODE],[FORM_NAME],[FORM_CODE],[DATE_FROM],[TIME_FROM],[LOG_STAT],[MACHINE_NAME],[Exclusive],[session_no],[function],[job])";
                    Sql = Sql + "values('" + PCURRENT_USER + "','" + PCURRENT_GCODE + "','" + CurrentFicode + "','" + FormName.Name + "'," + 0 + ",'" + getSqlDateStr(DateTime.Today) + "','" + DateTime.Now.ToLongTimeString() + "'," + 0 + ",'" + Environment.MachineName.ToString() + "'," + xlsv + "," + CURRENTSESSION + ",'" + func + "','" + job + "')";
                    //    "insert into Midaslog([LOG_UCODE],[LOG_GCODE],[LOG_CCODE],[FORM_NAME],[FORM_CODE],[DATE_FROM],[TIME_FROM],[LOG_STAT],[MACHINE_NAME],[Exclusive],[session_no],[function],[job],[AUTOINCRE])";
                    //Sql = Sql + "values('" + PCURRENT_USER + "','" + PCURRENT_GCODE + "','" + CurrentFicode + "','" + FormName.Name + "'," + 0 + ",'" + getSqlDateStr(DateTime.Today) + "','" + DateTime.Now.ToLongTimeString() + "'," + 0 + ",'" + Environment.MachineName.ToString() + "'," + xlsv + "," + CURRENTSESSION + ",'" + func + "','" + job + "',(Select max(AUTOINCRE) from Midaslog)+1)";
                    SqlCommand sqlcmd = new SqlCommand(Sql, edpcon.mycon);
                    sqlcmd.ExecuteNonQuery();
            ...
            try
            {
                ...
                if (Opn_Close)
                {
                    if (Exclusive)
                        ...
                        xlsv = 0;
                    string Sql = "insert into Midaslog(LOG_UCODE, LOG_GCODE, LOG_CCODE,FORM_NAME, FORM_CODE, DATE_FROM, TIME_FROM,LOG_STAT, MACHINE_NAME, Exclusive, session_no,[function], [job],[AUTOINCRE])";
                    Sql = Sql + "values('" + PCURRENT_USER + "','" + PCURRENT_GCODE + "','" + CurrentFicode + "','" + FormName.Name + "'," + 0 + ",'" + getSqlDateStr(DateTime.Today) + "','" + DateTime.Now.ToLongTimeString() + "'," + 0 + ",'" + Environment.MachineName.ToString() + "'," + xlsv + "," + CURRENTSESSION + ",'','',(Select max(AUTOINCRE) from Midaslog)+1)";
                    SqlCommand sqlcmd = new SqlCommand(Sql, edpcon.mycon);
                    sqlcmd.ExecuteNonQuery();
                    Sql = "select max(autoincre) from midaslog";
                    sqlcmd = new SqlCommand(Sql, edpcon.mycon);
        ...
        public void Entermenufirst(SqlConnection con)
        {
            try
            {
                ...
                //-----------------XXXXX---------------------------------------XXXXX------------------------------------------------------------------------------------------------------------------XXXXX-----------------------------------------------------------------------------------
                sql = sql + " UPDATE tbl_Employee_Mast SET Title = 'Sri.' WHERE (Title = 'Sri')";

                sql = sql + " UPDATE tbl_Employee_Mast SET FathTitle  = 'Sri.' WHERE (FathTitle = 'Sri')";
                sql = sql + " UPDATE tbl_Employee_Mast SET  Title = 'Late.' WHERE (Title = 'Late')";
                sql = sql + " UPDATE tbl_Employee_Mast SET FathTitle  = 'Late.' WHERE (FathTitle = 'Late')";
        ...
        public void Menu_Update()
        {
            ...
            CON.Close();
            CON.Open();
            Entermenufirst(CON.mycon);

            //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=40040000000 ", CON.mycon);
            //mycmd.ExecuteNonQuery();
            mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=40050000000 ", CON.mycon);
            mycmd.ExecuteNonQuery();
            CON.Close();

            // ------------------------------------ New Code Block --------------------------------------------------
            //added by Bibhas
            if (EnvironMent_Envelope == "Lite")
            {
                // ******* Admin *******
                CON.Close();
                CON.Open();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10000000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070100000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070200000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070300000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070400000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070500000", CON.mycon);
                mycmd.ExecuteNonQuery();

                              
                // ******* Master *******
                //gen master
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010030000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010040000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010050000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010060000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010070000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010080000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010090000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010100000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010100001", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010100002", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010100003", CON.mycon);
                mycmd.ExecuteNonQuery();
                //emp master
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020030000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020040000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020050000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020060000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020070000", CON.mycon);
                mycmd.ExecuteNonQuery();
               
                // sal master

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20030010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20030020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                //lnk master

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20040010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20040020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20040030000", CON.mycon);
                mycmd.ExecuteNonQuery();
               
                // ******* Employee *******

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=30010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=30010000001", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=30020000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=30260000000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                // ******* Salary *******

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=40010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=40020000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=40030000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                
                // ******* Transation *******
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=50000000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=50010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=50020000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                
                // ******* Report *******
                //salary rpt
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010001", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010002", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60010010003", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60010010004", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60010010009", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60010020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                
                //arrear rpt
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60060000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60060010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60060020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60060030000", CON.mycon);
                mycmd.ExecuteNonQuery();
                ...
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60110000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60120000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60130000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60140000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60150000000", CON.mycon);
                mycmd.ExecuteNonQuery();

                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60160000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                ...
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60190000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                ...
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=60080010000", CON.mycon);
                mycmd.ExecuteNonQuery();
               
                // ******* Configuration *******
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=70000000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=70010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=70012000000", CON.mycon);
                mycmd.ExecuteNonQuery();
               
            }
            else if (EnvironMent_Envelope == "Medium")
            {
                // ******* Admin *******
                CON.Close();
                CON.Open();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10000000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070100000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070200000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=10070300000", CON.mycon);
                ...
                // ******* Master *******
                //gen master
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010010000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010020000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010030000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010040000", CON.mycon);
                ...
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010050000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010060000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010070000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010080000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010090000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='False' where MENUCODE=20010100000", CON.mycon);
                ...
                // ******* Transation *******
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=50010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=50020000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                ...
                //bill print
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60080000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60070000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                ...
                // ******* Configuration *******
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=70000000000", CON.mycon);
                mycmd.ExecuteNonQuery();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=70010000000", CON.mycon);
                mycmd.ExecuteNonQuery();
               
            }
            else if (EnvironMent_Envelope == "Demo")
            {
                CON.Close();
                CON.Open();
                mycmd = new SqlCommand("update MenuTable set ENABLE_MENU=1", CON.mycon);
                mycmd.ExecuteNonQuery();
                /* Menu structure same as 
                  // ******* Admin *******
                  CON.Close();
                  CON.Open();
                  mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070100000", CON.mycon);
                  ...
                  mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=30010000000", CON.mycon);
                  mycmd.ExecuteNonQuery();
                  mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=30020000000", CON.mycon);
                  mycmd.ExecuteNonQuery();
            ...
            else if (EnvironMent_Envelope == "Enterprise")
            {
                // ******* Admin *******
                //CON.Close();
                //CON.Open();
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070100000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070200000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070300000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070400000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=10070500000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010020000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010030000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010040000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010050000", CON.mycon);
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010090000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010100000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010100001", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010100002", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20010100003", CON.mycon);
                //mycmd.ExecuteNonQuery();
                ////emp master
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=20020010000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=40030000000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=40020000001 ", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //// ******* Transation *******
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=50010000000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010002", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010003", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010004", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010010009", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60010020000", CON.mycon);
                //mycmd.ExecuteNonQuery();

                ////arrear rpt
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60060000000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60060010000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60060020000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60060030000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                ...
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60080000000", CON.mycon);
                //mycmd.ExecuteNonQuery();
                //mycmd = new SqlCommand("update MenuTable set ENABLE_MENU='True' where MENUCODE=60080010000", CON.mycon);
                //mycmd.ExecuteNonQuery();
