    ...
    public class clsfirsttime
    {
        ...
        public bool database_creation(string path, SqlConnection con, String Dbname)
        {
            ...
            try
            {
                ...
                strdb = strdb + " USE SchoolManagement;" + "\r\n";
        ...
        {
            string strmidlog = "create table Access(FICode char(10) not null,USER_CODE varchar(6) not null,GCODE char(10) not null,OPTION_STRING varchar(6) null,";
            strmidlog = strmidlog + "ENTRY_OPTION varchar(40),FORM_CODE int,DATE_FROM datetime,";
            strmidlog = strmidlog + "TIME_FROM char(2) null,REPORT_OPTION varchar(5) null,BRNCH_CODE numeric(18,0) null,RESTRICT_LOCN bit null,";
            strmidlog = strmidlog + "primary key clustered(USER_CODE))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
            {
           ...
           public bool AccPost_table_creation(SqlConnection con)
        {
            ...
            strmidlog = strmidlog + "Tax char(10) null,Glcode varchar(6) null,Formula varchar(20) null,Formula char(10) null,Type_Code numeric(18,0) null,";
        ...
        {
            string strmidlog = "create table Company(CO_CODE char(10) not null,FICode char(10) not null,GCODE char(10) not null,CO_NAME varchar(40)  null,CO_ADD varchar(40)  null,CO_ADD1 varchar(40)  null,CO_SDATE datetime null,CO_EDATE  datetime null,CO_VER varchar(7) null,CO_CDT datetime null, CO_link char(2) null,";
        ...
        {
            string strmidlog = "create table tbl_Config_FeeEx(Ficode char(10) not null,GCode  char(10) not null,AutoIncre numeric(18,0) not null,FeeID numeric(18,0)  null,Type varchar(100) null,Percentage float null,InsertionDate datetime not null DEFAULT(getdate()),";
        ...
        {
            string strmidlog = "create table tbl_Employee_Assign_SalStructure(SLNO int not null,P_TYPE char(1) not null,SESSION varchar(50) not  null,SAL_STRUCT int not null,SAL_HEAD int not null,V_FROM varchar(50) not  null,V_TO varchar(50) not  null,C_BASIS varchar(50) null,C_TYPE varchar(50) null,C_DET int null,PF_PER int null,PF_VOL int null,ESI_PER int null,PT int null,ROUND_TYPE varchar(50) null,TDSREFNO int null,TDS_EXEMPT int null,CARRY int null,TDS_EXTRAPOL int null,REMARKS varchar(100) null, ";
        ...
        {
            string strmidlog = "create table tbl_Employee_Attendance(SlNo int not null,ID varchar(50) null,Status bit  null,Remarks varchar(max) null,LeaveDate datetime null,InsertionDate datetime not null DEFAULT(getdate()),DayStatus int null,LeaveType int null,FstLeave int null,SndLeave int null,Season varchar(20) null,LeaveType1 int null,";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_Config_Retirement(SlNo int not null,Session varchar(50) null,Age  int null,InsertionDate datetime not null DEFAULT(getdate()),PenssionAge int null,";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_DeductionSalayHead(SlNo int not null,SalaryHead_Full varchar(max) null,SalaryHead_Short  varchar(50) null,Amount numeric(18,2) null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_DesignationMaster(SlNo int not null,DesignationName varchar(50) null,ShortForm varchar(50) null,InsertionDate datetime  not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_ErnSalaryHead(SlNo int not null,SalaryHead_Full varchar(max) null,SalaryHead_Short varchar(50) null,Amount numeric(18,2) null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_FamilyDetails(SlNo int not null,ID varchar(50) not null,Name varchar(50) null,Relation varchar(50) null,Age int null,Dependent bit null,InsertionDate datetime not null DEFAULT(getdate()),";
        ...
        {
            string strmidlog = "create table tbl_Employee_Holiday(SrlNo int not null,HolDate datetime not null, HolidayName varchar(100) not null,NationFlag varchar(10) not null,HolRemarks varchar(300) null,HolSession varchar(50) null,";
        ...
        {
            string strmidlog = "create table tbl_Employee_JobType(SlNo int not null,JobType varchar(50) null, ShortForm varchar(50) null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_Lumpsum(LUMPID int not null,LUMPNAME varchar(50) not null, LUMPTYPE int not null,GRADE int null,STRUCID int null,AMOUNT numeric(15,2) not null,";
            strmidlog = strmidlog + "primary key clustered(LUMPID,LUMPTYPE))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
            {
        ...
        {
            string strmidlog = "create table tbl_Employee_PTRate(Slno int identity(1,1) not null,monthof  varchar(50) null,Session varchar(50) null,wfrom numeric(18,2) null,wto nvarchar(50) null,pt numeric(18,2) null,ptgroup varchar(50) null,";
            strmidlog = strmidlog + "primary key clustered(Slno))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_QualificationDetails(SlNo int  not null,ID  varchar(50) not null,Qualification varchar(50) null,University varchar(50) null,YearOfPassing int null,Percentage int null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(Slno,ID))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        {
            string strmidlog = "create table tbl_Employee_SalaryDet(Slno int not null,EmpId varchar(50) not null,SalId int not null,TableName varchar(100) not null,Amount numeric(18,0) null,Month varchar(50) not null,Session varchar(50) not null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(EmpId,SalId,TableName,Month,Session))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
            {
        ...
        {
            string strmidlog = "create table tbl_Employee_SalaryMast(Slno int not null,Emp_Id varchar(50) not null,TotalSal  numeric(18,2) null,TotalDec numeric(18,2) null,NetPay numeric(18,2) null,Month varchar(50) not null,Session varchar(50) not null,InsertionDate datetime not null DEFAULT(getdate()),DaysPresent numeric(18,2) null,LeaveWithPay numeric(18,2) null,LeaveWithoutPay numeric(18,2) null,TotalDays int null,GrossAmount numeric(18,2) null,PFDue numeric(18,2) null,TotalPF numeric(18,2) null,Special numeric(18,2) null,Exgratia numeric(18,2) null,Date_of_Insert datetime null,";
            strmidlog = strmidlog + "primary key clustered(Emp_Id,Month,Session))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
            {
        ...
        {
            string strmidlog = "create table tbl_Employee_SalaryStructure(SlNo int not null,SalaryCategory varchar(max) null,InsertionDate datetime not null DEFAULT(getdate()),";
            strmidlog = strmidlog + "primary key clustered(SlNo))";
            SqlCommand cmd;
            cmd = new SqlCommand(strmidlog, con);
            try
        ...
        //{
        //    string strmidlog = "create table AccordFourlogDetail(LOG_UCODE varchar(6) not null,LOG_GCODE char(10) not null,LOG_CCODE char(10) not null,AUTOINCRE int IDENTITY(1,1) not null,";
        //    strmidlog = strmidlog + "Company_NAME varchar(100),FORM_CODE int,DATE_FROM datetime,";
        //    strmidlog = strmidlog + "TIME_FROM varchar(50),DATE_TO datetime,TIME_TO varchar(50),";
        //    strmidlog = strmidlog + "LOG_STAT int,MACHINE_NAME varchar(20),Exclusive bit,";
        //    strmidlog = strmidlog + "session_no int,primary key clustered(LOG_UCODE,LOG_GCODE,LOG_CCODE,AUTOINCRE 
        //    try
        ...
        //{
        //    string Country = "CREATE TABLE Country (Country_CODE numeric (18,0) NOT NULL,Country_Name VARCHAR (200) NOT NULL,Country_Detail numeric (18,0),primary key clustered (Country_CODE))";
        ...
        public bool veryfirst(SqlConnection con)
        {
            ...
            try
            {
                ...
                if (password_table_creation(con))
                {
                    ...
                    if (AccordFourlog_table_creation(con))
                    {
                        con.Close();
                        return true;
                    }
...
//}         // coded by amit  19/11/2013
        ...
        public bool firstimemethod(SqlConnection con)
        {
            try
            {
                ...
                sqlstr = sqlstr + " Declare @gcode Char(10),@ficode char(10),@name varchar(50),@StateCode Varchar(10)" + Environment.NewLine;
                sqlstr = sqlstr + " select @gcode=gcode,@ficode=ficode,@name=CO_NAME,@StateCode=convert(Varchar,State_Code) from inserted " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 1, 0, 'Capital Account', null, 30, 0, 0, 'BL',0,'C', '1', 1,0, 0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 2, 0, 'Loan Funds', null, 30, 0, 0, 'BL',0,'C', 2, 1,0, 0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 3, 0, 'Current Liabilities & Provisions', null, 30, 0, 0, 'BL',0,'C', '3',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 4, 0, 'Fixed Assets', null, 30, 0, 0, 'BA',0,'D','4',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 5, 0, 'Investments', null, 30, 0, 0, 'BA',0,'D', '5',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 6, 0, 'Current Assets,Loans & Advances', null, 30, 0, 0, 'BA',0,'D','6',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 7, 0, 'Miscellaneous Expenditure', null, 30, 0, 0, 'BA',0,'D','7',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 8, 0, 'Direct Expenses', null, 31, 0, 0, 'TD',0,'D','8',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 9, 0, 'Sales', null, 60, 0, 0, 'TC',0,'C','9',1,0, 0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 10,0, 'Indirect Expenses', null, 31, 0, 0, 'PD',0,'D','10',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 11,0, 'Indirect Income', null, 31, 0, 0, 'PC',0,'C','11',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 12,0, 'Profit & Loss', null, 30, 0, 0, 'PL',0,'C','12',1,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 13,0, 'UnExchanged Foreign Currency Gain/Loss', null, 75, 0, 0, 'FB',0,'X','13',0,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO grp VALUES(@ficode,@gcode, 14,0, 'Realized Foreign Currency Gain/Loss', null, 76, 0, 0, 'FP',0,'X','14',0,0,0,null,'As Per Details')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESS(USER_CODE,ficode,GCODE) VALUES('1',@ficode,@gcode)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESS(USER_CODE,ficode,GCODE) VALUES('2',@ficode,@gcode)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESS(USER_CODE,ficode,GCODE) VALUES('3',@ficode,@gcode)" + Environment.NewLine;
                ...
                sqlstr = sqlstr + " INSERT INTO ACCESSBRANCH(USER_CODE,ficode,GCODE,BRNCH_CODE) VALUES('2',@ficode,@gcode,0)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESSBRANCH(USER_CODE,ficode,GCODE,BRNCH_CODE) VALUES('2',@ficode,@gcode,1)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESSBRANCH(USER_CODE,ficode,GCODE,BRNCH_CODE) VALUES('3',@ficode,@gcode,0)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO ACCESSBRANCH(USER_CODE,ficode,GCODE,BRNCH_CODE) VALUES('3',@ficode,@gcode,1)" + Environment.NewLine;
                //sqlstr = sqlstr + " DELETE FROM CNFGMST" + Environment.NewLine;
                ...
                //sqlstr = sqlstr + " EXEC InvMst_ins @pFICode=@ficode" + Environment.NewLine;
                ...
                //sqlstr = sqlstr + " EXEC userfrml_ins @pFICode=@ficode,@pGcode=@gcode" + Environment.NewLine;
                ...
                sqlstr = sqlstr + " BEGIN" + Environment.NewLine;
                sqlstr = sqlstr + "INSERT INTO branch( ficode,GCODE,Brnch_Code,Brnch_Name,Stax,STT,BRNCH_STATE) VALUES(@ficode,@gcode,0,@name,12.36,0.25,@StateCode)" + Environment.NewLine;
                sqlstr = sqlstr + "INSERT INTO branch( ficode,GCODE,Brnch_Code,Brnch_Name,Stax,STT,BRNCH_STATE) VALUES(@ficode,@gcode,1,@name,12.36,0.25,@StateCode)" + Environment.NewLine;
                //sqlstr = sqlstr + "DELETE FROM INFLT" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1981','03/31/1982',100.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1982','03/31/1983',109.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1983','03/31/1984',116.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1984','03/31/1985',125.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1985','03/31/1986',133.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1986','03/31/1987',140.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1987','03/31/1988',150.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1988','03/31/1989',161.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1989','03/31/1990',172.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1990','03/31/1991',182.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1991','03/31/1992',199.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1992','03/31/1993',223.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1993','03/31/1994',244.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1994','03/31/1995',259.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1995','03/31/1996',281.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1996','03/31/1997',305.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1997','03/31/1998',331.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1998','03/31/1999',351.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/1999','03/31/2000',389.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2000','03/31/2001',406.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2001','03/31/2002',426.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2002','03/31/2003',447.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2003','03/31/2004',463.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2004','03/31/2005',480.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2005','03/31/2006',497.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2006','03/31/2007',519.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2007','03/31/2008',551.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2008','03/31/2009',582.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "INSERT INTO INFLT values('04/01/2009','03/31/2010',632.00)" + Environment.NewLine;
                //sqlstr = sqlstr + "DELETE FROM CNFGMST" + Environment.NewLine;
                //sqlstr = sqlstr + " EXEC CNFGMST_ins " + Environment.NewLine;
                sqlstr = sqlstr + " end" + Environment.NewLine;
                ...
                "INSERT INTO glmst VALUES(@ficode,@gcode,'L',10,19,10,'ROUND OFF','ROUNDOFF',30,0,0,0,1,0,'0000000000',0,'C','2',0,NULL,NULL,1,'1',1,1,0,0,0,NULL,0,0,0,0,0,NULL,'A',NULL,NULL,NULL,NULL,NULL,NULL,'0','As Per Details',NULL)" + Environment.NewLine;

                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 6,14,1,  'Cash Account', null, 20, 0, 0, 0, 1, 14, '0000000000', 0, 'D','1' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 12, 0, 2,  'Profit & Loss A/C', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 6, 0, 3,  'Opening Balance Debit A/C', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'D','3' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 3, 0, 4,  'Opening Balance Credit A/C', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','4' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 5, 0, 5,  'Investment In Shares', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 5, 0, 6,  'Investment In Mutual Funds', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 3, 27, 7,  'Broker A/C', null, 30, 0, 0, 0, 1, 27, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 8,  'Security Transaction Tax','STT', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 5,  'Service Tax', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 6,  'Transaction Charges', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 11,  'Long Term Capital Loss', 'LTCL', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 12,  'Short Term Capital Loss', 'STCL', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 7,  'Miscellenious Charges', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 11, 0, 14,  'Long Term Capital Gain', 'LTCG', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 11, 0, 15,  'Short Term Capital Gain', 'LTCL', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 16,  'Long Term Capital Loss On Mutual Fund', 'LTCLMF', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 17,  'Short Term Capital Loss On Mutual Fund', 'STCLMF', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 11, 0, 18,  'Long Term Capital Gain On Mutual Fund', 'LTCGMF', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 11, 0, 19,  'Short Term Capital Gain On Mutual Fund', 'STCGMF', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 20,  'Trn.Over Charges', 'TOC', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 8, 0, 21,  'Stamp Charges', 'SC', 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 3, 6, 8,  'Edu. CESS A/C', 'EC', 30, 0, 0, 0, 1, 6, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 3, 6, 9,  'Higher Edu. CESS A/C', 'HEC', 30, 0, 0, 0, 1, 6, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 1, 1, 0,  'Reserve & Surplus', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','13' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Reserve & Surplus','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 2, 2, 0,  'Secured Loans', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','14' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Secured Loans','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 2, 3, 0,  'Unsecured Loans', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','15' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Unsecured Loans','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 2, 4, 0,  'Bank Overdraft', null, 21, 0, 0, 0, 1, 0, '0000000000', 0, 'C','16' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Bank Overdraft','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3, 5, 0,  'Sundry Creditors', null, 23, 0, 0, 0, 1, 0, '0000000000', 0, 'C','17' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Sundry Creditors','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',3,  6, 0,  'Duties & Taxes', null, 32, 0, 0, 0, 1, 0, '0000000000', 0, 'C','18' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Duties & Taxes','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3,  7, 0,  'Provision', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','19' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Provision','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3,  8, 0,  'Provision for Taxation', null, 30, 0, 0, 0, 2, 7, '0000000000', 0, 'C','20' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Provision for Taxation','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3,  9, 0,  'Provision for Dividend', null, 30, 0, 0, 0, 2, 7, '0000000000', 0, 'C','21' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Provision for Dividend','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 4, 10, 0,  'Fixed Asstes at Cost', null, 30, 0, 0, 0,1, 0, '0000000000', 0, 'D','22' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Fixed Asstes at Cost','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 4, 11, 0,  'Less Accumulated Depreciation', null, 30, 0, 0, 0, 1,0, '0000000000', 0, 'C','23' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Less Accumulated Depreciation','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 12, 0,  'Sundry Debtors', null, 22, 0, 0, 0, 1, 0, '0000000000', 0, 'D','24' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Sundry Debtors','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 13, 0,  'Stock in Hand', null, 70, 0, 0, 0, 1, 0, '0000000000', 0, 'D','25' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Stock in Hand','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 14, 0,  'Cash Balances', null, 20, 0, 0, 0, 1, 0, '0000000000', 0, 'D','26' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Cash Balances','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 15, 0,  'Bank Balances', null, 21, 0, 0, 0, 1, 0, '0000000000', 0, 'D','27' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Bank Balances','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 16, 0,  'Short Term Investments', null, 21, 0, 0, 0, 2, 15, '0000000000', 0, 'D','28' ,1, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Short Term Investments','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 6, 17, 0,  'Loans and Advances', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Loans and Advances','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 8, 18, 0,  'Purchase Account', null, 50, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Purchase Account','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',10, 19, 0,  'Administration & Selling Expenses', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Administration & Selling Expenses','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',10, 20, 0,  'Finance Expenses', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Finance Expenses','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',10, 21, 0,  'Interest Expenses', null, 31, 0, 0, 0, 2, 20, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Interest Expenses','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',10, 22, 0,  'Dividend Expenses', null, 31, 0, 0, 0, 2, 20, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Dividend Expenses','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',11, 23, 0,  'Profit on Sale of Investments', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Profit on Sale of Investments','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',11, 24, 0,  'Profit on Sale of Fixed Assets', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Profit on Sale of Fixed Assets','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',11, 25, 0,  'Investment Income', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Investment Income','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S',11, 26, 0,  'Extraordinary Expenses', null, 31, 0, 0, 0, 1, 0, '0000000000', 0, 'D','29' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Extraordinary Expenses','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3, 27, 0,  'Broker', null, 23, 0, 0, 0, 2, 5, '0000000000', 0, 'C','40' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Broker','0','As Per Details',NULL) " + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 4, 28, 0,  'Less Depriciation Of Factory Equipments', null, 33, 0, 0, 0, 1,0, '0000000000', 0, 'C','41' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Less Depriciation Of Factory Equipments','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 8, 29, 0,  'Opening Stock', null, 30, 0, 0, 0, 1,0, '0000000000', 0, 'C','41' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'Opening Stock','0','As Per Details',NULL)" + Environment.NewLine;
                sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'S', 3, 30, 0,  'VAT', null, 31, 0, 0, 0, 2,6, '0000000000', 0, 'C','41' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, 'VAT','0','As Per Details',NULL)" + Environment.NewLine;
                //sqlstr = sqlstr + " INSERT INTO glmst VALUES(@ficode,@gcode, 'L', 5, 0, 24,  'Investment In Commodities', null, 30, 0, 0, 0, 1, 0, '0000000000', 0, 'C','2' ,0, null, null, 1, '1', 1, 1,  0, 0,0,null,0, 0, 0, 0, 0, null,'A', null, null, null, null, null, null,'0')" + Environment.NewLine;
                ...
                sqlstr = sqlstr + " insert into currency values(@pFICode,@pGcode,'1','Indian Rupee','Rs.','Paisa',null,null,1,null,null,null,',','2','R')" + Environment.NewLine;
                sqlstr = sqlstr + " end" + Environment.NewLine;
                cmd = new SqlCommand(sqlstr, con);
                try
                {
        ...
        {
            string qry = " Create TRIGGER [dbo].[TrigCompInsertSetting] on [dbo].[Company] For insert as set nocount on " +
